		...
		if ($result->num_rows > 0) {
            ...
            <tr>
				...
				while( $row = $result->fetch_assoc() ) {
					...
					<td>{$row['CPF']}</td>
					<td>
							<a href='edit.php?id={$row['id']}' class='buttons'>Edit</a>
							<a href='delete.php?id={$row['id']}' class='buttons'>Delete</a>
							<a href='view.php?id={$row['id']}' class='buttons'>View Details</a>
					</td>
				</tr>";
				}
				echo "<a class='link_add' href='add.php'> Adicionar novo paciente</a>";
				echo "</table";
		} else{	
			echo "0 results";
			echo "<a class='link_add' href='add.php'> Adicionar novo paciente</a>";
